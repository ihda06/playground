...
export const ProfileHeader = ({expandMenu, imageSize}) => {
  ...
  return (
    <div className={"flex items-center lg:items-start gap-4 lg:gap-1 flex-grow lg:flex-col w-full transition-all " + (expandMenu ? "flex-col !items-start" : "")}>
      ...
      <Link href="https://www.instagram.com/ihda.anwari" aria-label="To Instagram" className="hidden lg:flex items-center gap-1 text-neutral-900 dark:text-neutral-200">
        <FaInstagram />
        <p>ihda.anwari</p>
      </Link>
    </div>
